  ...
  return (
    <div className='mt-7'>
        ...
        <p className='text-center text-gray-400 mt-2'>
            Discover Personalized travel itineraries, find the best destinations, and plan your dream vacation effortlessly with the power of AI. Let our smar assistant do the hard work while you enjoy the journey :D
        </p>
