...
export const suggestions=[
    {
        ...
        icon:<Globe2 className='text-blue-600 h-5 w-5'/>
    },
    {
        title:'Inspire me where to go',
        icon:<Plane className='text-red-600 h-5 w-5'/>
    },
    {
  ...
  return (
    <div className='mt-24 flex justify-center'>
        <div className='max-w-3xl w-full text-center space-y-6'>
            <h1 className='text-xl md:text-5xl fond-bold'>
           ...
           <p className='text-lg'>
            ...
            <div className='flex items-center justify-center flex-col'>
                ...
                <HeroVideoDialog
                    ...
                    thumbnailSrc="https://www.sunsiyam.com/media/qnfnzgmq/ssiv_general_04.jpg?width=782&height=521&mode=max"
